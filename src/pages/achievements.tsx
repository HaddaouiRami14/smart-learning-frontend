...
import { Trophy, BookOpen, CheckCircle, ClipboardList } from "lucide-react";
...
const AchievementsPage = () => {
  ...
  return (
    <div className="flex">
      ...
      <main className="flex-1 ml-64 p-6 bg-gray-50 min-h-screen space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          {Object.keys(statIcons).map((key) => {
            ...
            return (
              <div key={key} className="flex items-center gap-4 bg-white shadow rounded-lg p-4 hover:shadow-lg transition">
          ...
          <div className="flex items-center gap-4 bg-white shadow rounded-lg p-4 hover:shadow-lg transition">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className={`flex flex-col items-center justify-center p-4 rounded-lg border transition transform hover:scale-105 cursor-pointer ${
                      badge.earned ? "bg-white border-yellow-400 shadow-md" : "bg-gray-100 border-gray-200 opacity-50"
                    }`}>
                  ...
                  return (
                    <tr
                      ...
                      className={`border-t transition hover:bg-gray-100 ${
                        isMe ? "bg-yellow-100 font-bold" : "bg-white"
                      }`}
                    >
